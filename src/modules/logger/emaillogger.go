...
var emailModule *EmailLoggerModule

//------------------------------------------------------------------------------

func EmailLoggerStart() error {
	//initialize module
	emailModule = &EmailLoggerModule{}
	emailModule.shutdownSignal = make(chan struct{})

	return nil
}

func EmailLoggerStop() {
	if emailModule != nil {
		//signal shutdown
...
func EmailLoggerRun(wg sync.WaitGroup) {
	if emailModule != nil {
...
func EmailLoggerInfo(channel string, format string, a ...interface{}) {
	emailModule.sendEmailNotification(channel, "[INFO]", format, a...)
	return
}

func EmailLoggerWarn(channel string, format string, a ...interface{}) {
	emailModule.sendEmailNotification(channel, "[WARN]", format, a...)
	return
}

func EmailLoggerError(channel string, format string, a ...interface{}) {
...
func (module *EmailLoggerModule) sendEmailNotification(channel string, title string, format string, a ...interface{}) {
	module.wg.Add(1)
